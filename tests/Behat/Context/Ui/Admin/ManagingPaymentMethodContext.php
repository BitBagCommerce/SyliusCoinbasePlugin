...
namespace Tests\BitBag\SyliusCoinbasePlugin\Behat\Context\Ui\Admin;

use Behat\Behat\Context\Context;
use Tests\BitBag\SyliusCoinbasePlugin\Behat\Page\Admin\PaymentMethod\CreatePageInterface;
...
final class ManagingPaymentMethodContext implements Context
{
     ...
     */
    public function iWantToCreateANewCoinbasePaymentMethod(): void
    {
        $this->createPage->open(['factory' => 'coinbase']);
    }
    ...
    /**
     * @When I fill the Webhook Secret Key with :arg1
     */
    public function iFillTheWebhookSecretKeyWith(string $webhookSecretKey): void
    {
